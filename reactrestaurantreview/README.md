...
```
git clone https://github.com/elekarlsen/restaurantreview.git
npm install
```
...
![Service worker message](https://github.com/elekarlsen/react-neighborhood-map/raw/master/src/images/confirm-service-worker.png)

react-neighborhood-map/src/images/foursquare-button.png

or in the Applications tab of Dev Tools:

![Service worker in Applications tab](https://github.com/elekarlsen/react-neighborhood-map/raw/master/src/images/confirm-service-worker2.png)
